...
El proyecto inició estableciendo una base estratégica sólida durante el TB1, donde la aplicación de metodologías ágiles, Lean UX y técnicas como event storming permitieron definir claramente el problema y centrar el diseño en las necesidades del usuario. Esta fase de planificación y modelado facilitó una transición fluida hacia el Trabajo Parcial (TP), momento en el cual el equipo consolidó el avance técnico mediante la implementación del primer Sprint y la definición de una arquitectura UX coherente, logrando integrar eficazmente la visión estratégica con los primeros desarrollos de la aplicación web y el backend.

Posteriormente, durante el TB2, el desarrollo alcanzó su madurez técnica con la implementación y el despliegue exitoso de todos los componentes clave: aplicación web, móvil y backend en plataformas productivas como Render y Firebase. En esta etapa, el equipo no solo demostró capacidad de ejecución técnica, sino también un compromiso con la calidad, aplicando heurísticas de usabilidad y validaciones preliminares que aseguraron una experiencia de usuario óptima, fortaleciendo así la funcionalidad y la estabilidad del sistema de cara a su uso real.

Finalmente, el Trabajo Final (TF) cerró el ciclo mediante la validación de las hipótesis centrales del negocio a través de entrevistas con los usuarios objetivo, confirmando que funcionalidades críticas como las alertas preventivas, la telemetría y el historial centralizado resuelven problemáticas reales de motociclistas y mecánicos. Esta validación demuestra que el producto final no solo es técnicamente viable, sino que se alinea profundamente con el mercado, entregando una solución intuitiva y de alto valor que deja el proyecto posicionado sobre una base sólida para su escalabilidad y futura adopción.
