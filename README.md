...
**TF**: Durante el desarrollo del Trabajo Final, el equipo de trabajo logró consolidar y perfeccionar el proyecto mediante la implementación de mejoras basadas en la retroalimentación obtenida durante las fases anteriores. Se realizaron ajustes significativos en la web application, mobile application y backend, optimizando la experiencia de usuario y la funcionalidad del sistema. Además, se llevaron a cabo pruebas exhaustivas para garantizar la estabilidad y el rendimiento de las aplicaciones. El equipo también documentó detalladamente el proceso de desarrollo, incluyendo análisis de colaboración y registros de entrevistas, lo que facilitó la evaluación del proyecto. En conjunto, estas actividades permitieron entregar un producto final robusto y alineado con las necesidades del usuario, demostrando la capacidad del equipo para gestionar proyectos complejos de manera efectiva.
